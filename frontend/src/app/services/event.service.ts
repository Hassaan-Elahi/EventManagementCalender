...
export class EventService {
  ...
  public getEvents (year, month, date, pageNo=1, pageSize=5) {
    console.log(pageNo);
    console.log(pageSize);
    return this.http
        .get(environment.baseUrl + `event/${year}/${month}/${date}`, { params: {pageNo: pageNo.toString(), pageSize: pageSize.toString()}})
        .toPromise()
  }
